...
from temp.CompactBilinearPooling import CompactBilinearPooling
...
class ASSP(nn.Module):
    def __init__(self, in_channels, output_stride):
        ...
        self.CBP = CompactBilinearPooling(256, 256, 16384)
    ...
    def forward(self, x):
        ...
        # return torch.randn(16, 256, 32, 32).cuda()
        return x
