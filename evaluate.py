...
def parse_args():
    ...
    parser.add_argument('--gt_file', type=str, default='./CASIAv1.txt')
    parser.add_argument('--th', type=float, default=0.5)
    parser.add_argument("--model_name", type=str, help="Path to the pretrained model", default="checkpoints/20221219140754_MVSS-Net/20221219140754_189_1000.pth")
